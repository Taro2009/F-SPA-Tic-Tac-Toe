...
{
 "use strict";
 var Global,Tictactoe,Client,WebSharper,Obj,UI,Var$1,Collections,List,Operators,Unchecked,Random,Templating,Runtime,Server,TemplateInstance,Arrays,ProviderBuilder,Handler,Var,Tictactoe_Templates,ConcreteVar,Snap,Object,JavaScript,Pervasives,JS,System,Guid,Client$1,Templates,Doc,Abbrev,Fresh,Dictionary,HashSet,Seq,TemplateInitializer,EventTarget,Node,View,Numeric,AttrProxy,CheckedInput,DictionaryUtil,Enumerator,T,SC$1,WindowOrWorkerGlobalScope,Docs,SC$2,DocElemNode,CharacterData,Elt,Prepare,Slice,DomUtility,KeyCollection,An,Settings,Mailbox,Attrs,Dyn,Attrs$1,AttrModule,List$1,T$1,Strings,Array,Updates,ValueCollection,Docs$1,RunState,NodeSet,Concurrency,Anims,SC$3,HashSetUtil,BindVar,SC$4,SC$5,AppendList,SC$6,DynamicAttrNode,Scheduler,Easing,AsyncBody,SC$7,CT,HashSet$1,String,CancellationTokenSource,DomNodes,Char,Error,OperationCanceledException,Lazy,SC$8,Queue,LazyExtensionsProxy,LazyRecord,IntelliFactory,Runtime$1,Math,console,Date;
 Global=self;
 Tictactoe=Global.Tictactoe=Global.Tictactoe||{};
 Client=Tictactoe.Client=Tictactoe.Client||{};
 ...
 Var=UI.Var=UI.Var||{};
 Tictactoe_Templates=Global.Tictactoe_Templates=Global.Tictactoe_Templates||{};
 ...
 {
  var gameCell0,gameCell1,gameCell2,gameCell3,gameCell4,gameCell5,gameCell6,gameCell7,gameCell8,hardMode,gameIsOver,endresult,aiplace,AIList,playerList,a,b,t,t$1,t$2,t$3,t$4,t$5,t$6,t$7,t$8,t$9,t$10,_this,_this$1,_this$2,_this$3,_this$4,_this$5,_this$6,_this$7,_this$8,_this$9,p,i;
  function CheckWin(plist)
  {
   return Unchecked.Equals(Arrays.get(plist,0),true)&&Unchecked.Equals(Arrays.get(plist,1),true)&&Unchecked.Equals(Arrays.get(plist,2),true)||Unchecked.Equals(Arrays.get(plist,3),true)&&Unchecked.Equals(Arrays.get(plist,4),true)&&Unchecked.Equals(Arrays.get(plist,5),true)||Unchecked.Equals(Arrays.get(plist,6),true)&&Unchecked.Equals(Arrays.get(plist,7),true)&&Unchecked.Equals(Arrays.get(plist,8),true)||Unchecked.Equals(Arrays.get(plist,0),true)&&Unchecked.Equals(Arrays.get(plist,4),true)&&Unchecked.Equals(Arrays.get(plist,8),true)||Unchecked.Equals(Arrays.get(plist,2),true)&&Unchecked.Equals(Arrays.get(plist,4),true)&&Unchecked.Equals(Arrays.get(plist,6),true)||Unchecked.Equals(Arrays.get(plist,0),true)&&Unchecked.Equals(Arrays.get(plist,3),true)&&Unchecked.Equals(Arrays.get(plist,6),true)||Unchecked.Equals(Arrays.get(plist,1),true)&&Unchecked.Equals(Arrays.get(plist,4),true)&&Unchecked.Equals(Arrays.get(plist,7),true)||Unchecked.Equals(Arrays.get(plist,2),true)&&Unchecked.Equals(Arrays.get(plist,5),true)&&Unchecked.Equals(Arrays.get(plist,8),true);
  }
  function checkDraw(plist,ailist)
  {
   return(Unchecked.Equals(Arrays.get(plist,0),true)||Unchecked.Equals(Arrays.get(ailist,0),true))&&(Unchecked.Equals(Arrays.get(plist,1),true)||Unchecked.Equals(Arrays.get(ailist,1),true))&&(Unchecked.Equals(Arrays.get(plist,2),true)||Unchecked.Equals(Arrays.get(ailist,2),true))&&(Unchecked.Equals(Arrays.get(plist,3),true)||Unchecked.Equals(Arrays.get(ailist,3),true))&&(Unchecked.Equals(Arrays.get(plist,4),true)||Unchecked.Equals(Arrays.get(ailist,4),true))&&(Unchecked.Equals(Arrays.get(plist,5),true)||Unchecked.Equals(Arrays.get(ailist,5),true))&&(Unchecked.Equals(Arrays.get(plist,6),true)||Unchecked.Equals(Arrays.get(ailist,6),true))&&(Unchecked.Equals(Arrays.get(plist,7),true)||Unchecked.Equals(Arrays.get(ailist,7),true))&&(Unchecked.Equals(Arrays.get(plist,8),true)||Unchecked.Equals(Arrays.get(ailist,8),true));
  }
  function AIStep(plist,ailist)
  {
   var counter,retval,$1,i$1,$2,rand,choice,i$2,$3;
   counter=0;
   retval=0;
   for(i$1=0,$2=Arrays.length(plist)-1;i$1<=$2;i$1++)counter=Unchecked.Equals(Arrays.get(plist,i$1),false)&&Unchecked.Equals(Arrays.get(ailist,i$1),false)?counter+1:counter+0;
   rand=new Random.New();
   choice=rand.Next(1,counter+1);
   counter=0;
   for(i$2=0,$3=Arrays.length(plist)-1;i$2<=$3;i$2++)if(Unchecked.Equals(Arrays.get(plist,i$2),false)&&Unchecked.Equals(Arrays.get(ailist,i$2),false))
    {
     counter=counter+1;
     choice===counter?retval=i$2:void 0;
    }
   else
    counter=counter+0;
   return retval;
  }
  gameCell0=Var$1.Create$1("");
  gameCell1=Var$1.Create$1("");
  gameCell2=Var$1.Create$1("");
  gameCell3=Var$1.Create$1("");
  gameCell4=Var$1.Create$1("");
  gameCell5=Var$1.Create$1("");
  gameCell6=Var$1.Create$1("");
  gameCell7=Var$1.Create$1("");
  gameCell8=Var$1.Create$1("");
  hardMode=Var$1.Create$1(false);
  gameIsOver=Var$1.Create$1(false);
  endresult=Var$1.Create$1("");
  aiplace=Var$1.Create$1(0);
  AIList=[];
  AIList.push(false);
  AIList.push(false);
  AIList.push(false);
  ...
  playerList.push(false);
  playerList.push(false);
  a=(b=(t=(t$1=(t$2=(t$3=(t$4=(t$5=(t$6=(t$7=(t$8=(t$9=(t$10=(_this=(_this$1=(_this$2=(_this$3=(_this$4=(_this$5=(_this$6=(_this$7=(_this$8=(_this$9=new ProviderBuilder.New$1(),(_this$9.h.push({
   $:8,
   $0:"endgamevar",
   $1:endresult
   ...
   $0:"cell8var",
   $1:gameCell8
  }),_this)),(t$10.h.push(Handler.EventQ2(t$10.k,"startgameeasy",function()
  {
   return t$10.i;
  },function()
  {
   Arrays.set(playerList,0,false);
   Arrays.set(playerList,1,false);
   Arrays.set(playerList,2,false);
   Arrays.set(playerList,3,false);
   Arrays.set(playerList,4,false);
   Arrays.set(playerList,5,false);
   Arrays.set(playerList,6,false);
   Arrays.set(playerList,7,false);
   Arrays.set(playerList,8,false);
   Arrays.set(AIList,0,false);
   Arrays.set(AIList,1,false);
   Arrays.set(AIList,2,false);
   Arrays.set(AIList,3,false);
   Arrays.set(AIList,4,false);
   Arrays.set(AIList,5,false);
   Arrays.set(AIList,6,false);
   Arrays.set(AIList,7,false);
   Arrays.set(AIList,8,false);
   ...
   endresult.Set("");
   hardMode.Set(false);
  })),t$10)),(t$9.h.push(Handler.EventQ2(t$9.k,"startgamehard",function()
  {
   return t$9.i;
  },function()
  {
   ...
   endresult.Set("");
   hardMode.Set(true);
  })),t$9)),(t$8.h.push(Handler.EventQ2(t$8.k,"cell0",function()
  {
   return t$8.i;
  },function()
  {
   if(Unchecked.Equals(gameIsOver.Get(),false))
   {
    if(Unchecked.Equals(Arrays.get(playerList,0),true))
     gameCell0.Set("O");
    else
     if(Unchecked.Equals(Arrays.get(AIList,0),true))
      gameCell0.Set("X");
     else
      {
       gameCell0.Set("O");
       Arrays.set(playerList,0,true);
       CheckWin(playerList)?(gameIsOver.Set(true),endresult.Set("Player wins!")):Unchecked.Equals(checkDraw(playerList,AIList),true)?(endresult.Set("It's a draw!"),gameIsOver.Set(true)):(gameIsOver.Set(false),aiplace.Set(AIStep(playerList,AIList)),aiplace.Get()===0?(gameCell0.Set("X"),Arrays.set(AIList,0,true)):aiplace.Get()===1?(gameCell1.Set("X"),Arrays.set(AIList,1,true)):aiplace.Get()===2?(gameCell2.Set("X"),Arrays.set(AIList,2,true)):aiplace.Get()===3?(gameCell3.Set("X"),Arrays.set(AIList,3,true)):aiplace.Get()===4?(gameCell4.Set("X"),Arrays.set(AIList,4,true)):aiplace.Get()===5?(gameCell5.Set("X"),Arrays.set(AIList,5,true)):aiplace.Get()===6?(gameCell6.Set("X"),Arrays.set(AIList,6,true)):aiplace.Get()===7?(gameCell7.Set("X"),Arrays.set(AIList,7,true)):(gameCell8.Set("X"),Arrays.set(AIList,8,true)),CheckWin(AIList)?(gameIsOver.Set(true),endresult.Set("AI wins!")):gameIsOver.Set(false));
      }
   }
   else
    gameIsOver.Set(true);
  })),t$8)),(t$7.h.push(Handler.EventQ2(t$7.k,"cell1",function()
  {
   return t$7.i;
  },function()
  {
   if(Unchecked.Equals(gameIsOver.Get(),false))
   {
    if(Unchecked.Equals(Arrays.get(playerList,1),true))
     gameCell1.Set("O");
    else
     if(Unchecked.Equals(Arrays.get(AIList,1),true))
      gameCell1.Set("X");
     else
      {
       gameCell1.Set("O");
       Arrays.set(playerList,1,true);
       CheckWin(playerList)?(gameIsOver.Set(true),endresult.Set("Player wins!")):Unchecked.Equals(checkDraw(playerList,AIList),true)?(endresult.Set("It's a draw!"),gameIsOver.Set(true)):(gameIsOver.Set(false),aiplace.Set(AIStep(playerList,AIList)),aiplace.Get()===0?(gameCell0.Set("X"),Arrays.set(AIList,0,true)):aiplace.Get()===1?(gameCell1.Set("X"),Arrays.set(AIList,1,true)):aiplace.Get()===2?(gameCell2.Set("X"),Arrays.set(AIList,2,true)):aiplace.Get()===3?(gameCell3.Set("X"),Arrays.set(AIList,3,true)):aiplace.Get()===4?(gameCell4.Set("X"),Arrays.set(AIList,4,true)):aiplace.Get()===5?(gameCell5.Set("X"),Arrays.set(AIList,5,true)):aiplace.Get()===6?(gameCell6.Set("X"),Arrays.set(AIList,6,true)):aiplace.Get()===7?(gameCell7.Set("X"),Arrays.set(AIList,7,true)):(gameCell8.Set("X"),Arrays.set(AIList,8,true)),CheckWin(AIList)?(gameIsOver.Set(true),endresult.Set("AI wins!")):gameIsOver.Set(false));
      }
   }
   else
    gameIsOver.Set(true);
  })),t$7)),(t$6.h.push(Handler.EventQ2(t$6.k,"cell2",function()
  {
   return t$6.i;
  },function()
  {
   if(Unchecked.Equals(gameIsOver.Get(),false))
   {
    if(Unchecked.Equals(Arrays.get(playerList,2),true))
     gameCell2.Set("O");
    else
     if(Unchecked.Equals(Arrays.get(AIList,2),true))
      gameCell2.Set("X");
     else
      {
       gameCell2.Set("O");
       Arrays.set(playerList,2,true);
       CheckWin(playerList)?(gameIsOver.Set(true),endresult.Set("Player wins!")):Unchecked.Equals(checkDraw(playerList,AIList),true)?(endresult.Set("It's a draw!"),gameIsOver.Set(true)):(gameIsOver.Set(false),aiplace.Set(AIStep(playerList,AIList)),aiplace.Get()===0?(gameCell0.Set("X"),Arrays.set(AIList,0,true)):aiplace.Get()===1?(gameCell1.Set("X"),Arrays.set(AIList,1,true)):aiplace.Get()===2?(gameCell2.Set("X"),Arrays.set(AIList,2,true)):aiplace.Get()===3?(gameCell3.Set("X"),Arrays.set(AIList,3,true)):aiplace.Get()===4?(gameCell4.Set("X"),Arrays.set(AIList,4,true)):aiplace.Get()===5?(gameCell5.Set("X"),Arrays.set(AIList,5,true)):aiplace.Get()===6?(gameCell6.Set("X"),Arrays.set(AIList,6,true)):aiplace.Get()===7?(gameCell7.Set("X"),Arrays.set(AIList,7,true)):(gameCell8.Set("X"),Arrays.set(AIList,8,true)),CheckWin(AIList)?(gameIsOver.Set(true),endresult.Set("AI wins!")):gameIsOver.Set(false));
      }
   }
   else
    gameIsOver.Set(true);
  })),t$6)),(t$5.h.push(Handler.EventQ2(t$5.k,"cell3",function()
  {
   return t$5.i;
  },function()
  {
   if(Unchecked.Equals(gameIsOver.Get(),false))
   {
    if(Unchecked.Equals(Arrays.get(playerList,3),true))
     gameCell3.Set("O");
    else
     if(Unchecked.Equals(Arrays.get(AIList,3),true))
      gameCell3.Set("X");
     else
      {
       gameCell3.Set("O");
       Arrays.set(playerList,3,true);
       CheckWin(playerList)?(gameIsOver.Set(true),endresult.Set("Player wins!")):Unchecked.Equals(checkDraw(playerList,AIList),true)?(endresult.Set("It's a draw!"),gameIsOver.Set(true)):(gameIsOver.Set(false),aiplace.Set(AIStep(playerList,AIList)),aiplace.Get()===0?(gameCell0.Set("X"),Arrays.set(AIList,0,true)):aiplace.Get()===1?(gameCell1.Set("X"),Arrays.set(AIList,1,true)):aiplace.Get()===2?(gameCell2.Set("X"),Arrays.set(AIList,2,true)):aiplace.Get()===3?(gameCell3.Set("X"),Arrays.set(AIList,3,true)):aiplace.Get()===4?(gameCell4.Set("X"),Arrays.set(AIList,4,true)):aiplace.Get()===5?(gameCell5.Set("X"),Arrays.set(AIList,5,true)):aiplace.Get()===6?(gameCell6.Set("X"),Arrays.set(AIList,6,true)):aiplace.Get()===7?(gameCell7.Set("X"),Arrays.set(AIList,7,true)):(gameCell8.Set("X"),Arrays.set(AIList,8,true)),CheckWin(AIList)?(gameIsOver.Set(true),endresult.Set("AI wins!")):gameIsOver.Set(false));
      }
   }
   else
    gameIsOver.Set(true);
  })),t$5)),(t$4.h.push(Handler.EventQ2(t$4.k,"cell4",function()
  {
   return t$4.i;
  },function()
  {
   if(Unchecked.Equals(gameIsOver.Get(),false))
   {
    if(Unchecked.Equals(Arrays.get(playerList,4),true))
     gameCell4.Set("O");
    else
     if(Unchecked.Equals(Arrays.get(AIList,4),true))
      gameCell4.Set("X");
     else
      {
       gameCell4.Set("O");
       Arrays.set(playerList,4,true);
       CheckWin(playerList)?(gameIsOver.Set(true),endresult.Set("Player wins!")):Unchecked.Equals(checkDraw(playerList,AIList),true)?(endresult.Set("It's a draw!"),gameIsOver.Set(true)):(gameIsOver.Set(false),aiplace.Set(AIStep(playerList,AIList)),aiplace.Get()===0?(gameCell0.Set("X"),Arrays.set(AIList,0,true)):aiplace.Get()===1?(gameCell1.Set("X"),Arrays.set(AIList,1,true)):aiplace.Get()===2?(gameCell2.Set("X"),Arrays.set(AIList,2,true)):aiplace.Get()===3?(gameCell3.Set("X"),Arrays.set(AIList,3,true)):aiplace.Get()===4?(gameCell4.Set("X"),Arrays.set(AIList,4,true)):aiplace.Get()===5?(gameCell5.Set("X"),Arrays.set(AIList,5,true)):aiplace.Get()===6?(gameCell6.Set("X"),Arrays.set(AIList,6,true)):aiplace.Get()===7?(gameCell7.Set("X"),Arrays.set(AIList,7,true)):(gameCell8.Set("X"),Arrays.set(AIList,8,true)),CheckWin(AIList)?(gameIsOver.Set(true),endresult.Set("AI wins!")):gameIsOver.Set(false));
      }
   }
   else
    gameIsOver.Set(true);
  })),t$4)),(t$3.h.push(Handler.EventQ2(t$3.k,"cell5",function()
  {
   return t$3.i;
  },function()
  {
   if(Unchecked.Equals(gameIsOver.Get(),false))
   {
    if(Unchecked.Equals(Arrays.get(playerList,5),true))
     gameCell5.Set("O");
    else
     if(Unchecked.Equals(Arrays.get(AIList,5),true))
      gameCell5.Set("X");
     else
      {
       gameCell5.Set("O");
       Arrays.set(playerList,5,true);
       CheckWin(playerList)?(gameIsOver.Set(true),endresult.Set("Player wins!")):Unchecked.Equals(checkDraw(playerList,AIList),true)?(endresult.Set("It's a draw!"),gameIsOver.Set(true)):(gameIsOver.Set(false),aiplace.Set(AIStep(playerList,AIList)),aiplace.Get()===0?(gameCell0.Set("X"),Arrays.set(AIList,0,true)):aiplace.Get()===1?(gameCell1.Set("X"),Arrays.set(AIList,1,true)):aiplace.Get()===2?(gameCell2.Set("X"),Arrays.set(AIList,2,true)):aiplace.Get()===3?(gameCell3.Set("X"),Arrays.set(AIList,3,true)):aiplace.Get()===4?(gameCell4.Set("X"),Arrays.set(AIList,4,true)):aiplace.Get()===5?(gameCell5.Set("X"),Arrays.set(AIList,5,true)):aiplace.Get()===6?(gameCell6.Set("X"),Arrays.set(AIList,6,true)):aiplace.Get()===7?(gameCell7.Set("X"),Arrays.set(AIList,7,true)):(gameCell8.Set("X"),Arrays.set(AIList,8,true)),CheckWin(AIList)?(gameIsOver.Set(true),endresult.Set("AI wins!")):gameIsOver.Set(false));
      }
   }
   else
    gameIsOver.Set(true);
  })),t$3)),(t$2.h.push(Handler.EventQ2(t$2.k,"cell6",function()
  {
   return t$2.i;
  },function()
  {
   if(Unchecked.Equals(gameIsOver.Get(),false))
   {
    if(Unchecked.Equals(Arrays.get(playerList,6),true))
     gameCell6.Set("O");
    else
     if(Unchecked.Equals(Arrays.get(AIList,6),true))
      gameCell6.Set("X");
     else
      {
       gameCell6.Set("O");
       Arrays.set(playerList,6,true);
       CheckWin(playerList)?(gameIsOver.Set(true),endresult.Set("Player wins!")):Unchecked.Equals(checkDraw(playerList,AIList),true)?(endresult.Set("It's a draw!"),gameIsOver.Set(true)):(gameIsOver.Set(false),aiplace.Set(AIStep(playerList,AIList)),aiplace.Get()===0?(gameCell0.Set("X"),Arrays.set(AIList,0,true)):aiplace.Get()===1?(gameCell1.Set("X"),Arrays.set(AIList,1,true)):aiplace.Get()===2?(gameCell2.Set("X"),Arrays.set(AIList,2,true)):aiplace.Get()===3?(gameCell3.Set("X"),Arrays.set(AIList,3,true)):aiplace.Get()===4?(gameCell4.Set("X"),Arrays.set(AIList,4,true)):aiplace.Get()===5?(gameCell5.Set("X"),Arrays.set(AIList,5,true)):aiplace.Get()===6?(gameCell6.Set("X"),Arrays.set(AIList,6,true)):aiplace.Get()===7?(gameCell7.Set("X"),Arrays.set(AIList,7,true)):(gameCell8.Set("X"),Arrays.set(AIList,8,true)),CheckWin(AIList)?(gameIsOver.Set(true),endresult.Set("AI wins!")):gameIsOver.Set(false));
      }
   }
   else
    gameIsOver.Set(true);
  })),t$2)),(t$1.h.push(Handler.EventQ2(t$1.k,"cell7",function()
  {
   return t$1.i;
  },function()
  {
   if(Unchecked.Equals(gameIsOver.Get(),false))
   {
    if(Unchecked.Equals(Arrays.get(playerList,7),true))
     gameCell7.Set("O");
    else
     if(Unchecked.Equals(Arrays.get(AIList,7),true))
      gameCell7.Set("X");
     else
      {
       gameCell7.Set("O");
       Arrays.set(playerList,7,true);
       CheckWin(playerList)?(gameIsOver.Set(true),endresult.Set("Player wins!")):Unchecked.Equals(checkDraw(playerList,AIList),true)?(endresult.Set("It's a draw!"),gameIsOver.Set(true)):(gameIsOver.Set(false),aiplace.Set(AIStep(playerList,AIList)),aiplace.Get()===0?(gameCell0.Set("X"),Arrays.set(AIList,0,true)):aiplace.Get()===1?(gameCell1.Set("X"),Arrays.set(AIList,1,true)):aiplace.Get()===2?(gameCell2.Set("X"),Arrays.set(AIList,2,true)):aiplace.Get()===3?(gameCell3.Set("X"),Arrays.set(AIList,3,true)):aiplace.Get()===4?(gameCell4.Set("X"),Arrays.set(AIList,4,true)):aiplace.Get()===5?(gameCell5.Set("X"),Arrays.set(AIList,5,true)):aiplace.Get()===6?(gameCell6.Set("X"),Arrays.set(AIList,6,true)):aiplace.Get()===7?(gameCell7.Set("X"),Arrays.set(AIList,7,true)):(gameCell8.Set("X"),Arrays.set(AIList,8,true)),CheckWin(AIList)?(gameIsOver.Set(true),endresult.Set("AI wins!")):gameIsOver.Set(false));
      }
   }
   else
    gameIsOver.Set(true);
  })),t$1)),(t.h.push(Handler.EventQ2(t.k,"cell8",function()
  {
   return t.i;
  },function()
  {
   if(Unchecked.Equals(gameIsOver.Get(),false))
   {
    if(Unchecked.Equals(Arrays.get(playerList,8),true))
     gameCell8.Set("O");
    else
     if(Unchecked.Equals(Arrays.get(AIList,8),true))
      gameCell8.Set("X");
     else
      {
       gameCell8.Set("O");
       Arrays.set(playerList,8,true);
       CheckWin(playerList)?(gameIsOver.Set(true),endresult.Set("Player wins!")):Unchecked.Equals(checkDraw(playerList,AIList),true)?(endresult.Set("It's a draw!"),gameIsOver.Set(true)):(gameIsOver.Set(false),aiplace.Set(AIStep(playerList,AIList)),aiplace.Get()===0?(gameCell0.Set("X"),Arrays.set(AIList,0,true)):aiplace.Get()===1?(gameCell1.Set("X"),Arrays.set(AIList,1,true)):aiplace.Get()===2?(gameCell2.Set("X"),Arrays.set(AIList,2,true)):aiplace.Get()===3?(gameCell3.Set("X"),Arrays.set(AIList,3,true)):aiplace.Get()===4?(gameCell4.Set("X"),Arrays.set(AIList,4,true)):aiplace.Get()===5?(gameCell5.Set("X"),Arrays.set(AIList,5,true)):aiplace.Get()===6?(gameCell6.Set("X"),Arrays.set(AIList,6,true)):aiplace.Get()===7?(gameCell7.Set("X"),Arrays.set(AIList,7,true)):(gameCell8.Set("X"),Arrays.set(AIList,8,true)),CheckWin(AIList)?(gameIsOver.Set(true),endresult.Set("AI wins!")):gameIsOver.Set(false));
      }
   }
   else
    gameIsOver.Set(true);
  })),t)),(p=Handler.CompleteHoles(b.k,b.h,[["cell0var",0],["cell1var",0],["cell2var",0],["cell3var",0],["cell4var",0],["cell5var",0],["cell6var",0],["cell7var",0],["cell8var",0],["endgamevar",0]]),(i=new TemplateInstance.New(p[1],Tictactoe_Templates.main(p[0])),b.i=i,i))).get_Doc();
 ...
 Tictactoe_Templates.main=function(h)
 {
